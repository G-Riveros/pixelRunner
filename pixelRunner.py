...
clock = pygame.time.Clock() #helps with time inorder to control frame rate
...
game_name = test_font.render('Pixle Runner',False,(111,196,169))
...
while True:
    ...
    pygame.display.update() # updayes screen
    clock.tick(60) # fram rate
